...
return [
    ...
    'attributes'             => [
        ...
        'position_appointment_date' => 'position appointment date',
        'position_sk_date' => 'position sk date',
        'position_sk_number' => 'position sk number',
        'position_sk_file' => 'position sk file',
        'rank_appointment_date' => 'rank appointment date',
        'rank_sk_date' => 'rank sk date',
        'rank_sk_number' => 'rank sk number',
        'rank_sk_file' => 'rank sk file',
        'university_name' => 'university name',
        'study_program' => 'study program',
        'education_program' => 'education program',
        'honorific_title' => 'honorific title',
        'post_nominal_title' => 'post nominal title',
